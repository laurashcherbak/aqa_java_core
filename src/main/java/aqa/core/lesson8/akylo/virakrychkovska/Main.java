...
public class Main {
    public static void main(String[]args){
        ...
        Rectangle myRectange=new Rectangle("White",12,15);
        Triangle myTriangle=new Triangle("Red", 4,8,10);
        Circle circle1=new Circle(11, "Pink");
        Circle circle2=new Circle(5,"Green");
        Triangle triangle1=new Triangle("Blue",8,5,9);
        Triangle triangle2=new Triangle("Purple", 7,3,4);
        ...
        Rectangle[]arr1={rectangle2, rectangle1};
        Drawable []arr2={circle1,circle2,rectangle1,rectangle2,triangle1,triangle2};
