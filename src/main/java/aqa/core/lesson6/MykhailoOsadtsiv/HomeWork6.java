...
public class HomeWork6 {
  //  public static int index = 1;
    ...
    //    System.out.println(fish2.getId());
        ...
        System.out.println(shark1.equals(shark2));
        System.out.println(shark1.hashCode());
        System.out.println(shark2.hashCode());

        shark2.eatFish(fish2);
        System.out.println(shark1.equals(shark2));
        System.out.println(shark1.hashCode());
        System.out.println(shark2.hashCode());
    }
